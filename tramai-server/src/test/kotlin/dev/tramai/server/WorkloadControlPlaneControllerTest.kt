...
class WorkloadControlPlaneControllerTest
    ...
    constructor(
        ...
        internal class Beans {
            @Bean
            internal fun workloadRegistrationStore(): InMemoryWorkloadRegistrationStore = InMemoryWorkloadRegistrationStore()

            @Bean
            internal fun workloadRegistrationAuthority(store: InMemoryWorkloadRegistrationStore): WorkloadRegistrationAuthority =
                WorkloadRegistrationAuthority(store)
        }
        ...
        private fun deployment(slug: String): WorkloadDeploymentIdentity = WorkloadRegistrationFixtures.identity(deployment = slug)
