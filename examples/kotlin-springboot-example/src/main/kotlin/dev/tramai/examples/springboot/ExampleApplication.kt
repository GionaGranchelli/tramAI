...
/**
 * Minimal Spring Boot application used to verify Tramai integration from Maven Local.
 */
...
interface InvoiceAnalyzer {
    ...
    suspend fun streamSummarize(invoiceText: String): kotlinx.coroutines.flow.Flow<dev.tramai.core.model.StreamChunk>
