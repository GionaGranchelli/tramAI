...
/**
 * Epic 6.1 TCK runner for [OpenAiCompatibleProvider] (any OpenAI-compatible
 * `/chat/completions` endpoint). Expected matrix pinned: VISION +
 * TOOL_CALLING + STRUCTURED_OUTPUT + STREAMING.
 */
class OpenAiCompatibleProviderTckTest : ProviderTck() {
    ...
    override val harness = ProviderTckHarness(
        ...
        createProvider = { stub ->
            OpenAiCompatibleProvider(
                accessTokenSource = StaticOpenAiAccessTokenSource("sk-tck-test-key"),
