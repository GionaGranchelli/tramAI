...
> ⚠️ **Staleness notice.** This graph is generated from the `v0.5.0` baseline and is **not** kept in sync with the current module set automatically. The authoritative module inventory is `config/quality/module-catalog.yml` (60 modules, verified by `verifyModuleDocContract`); this graph may lag it. Regeneration of this graph is owned by the build-architecture track — do not edit it by hand to chase the live module set.
