...
- `ApprovalRequestResults` — Java-friendly Preview factories for `ApprovalRequestResult` variants with String-based inline-value wrappers
- `HumanApprovalDecisions` — Java-friendly Preview factories for approval decisions, including `@JvmOverloads` short forms
