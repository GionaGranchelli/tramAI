...
- `board/`: execution tracking derived from approved specs
...
4. [Execution Board](./board/board.md)
5. [Roadmap Summary](./roadmap.md)
...
- a task board that turns approved specs into concrete execution slices
