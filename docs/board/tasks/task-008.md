...
- Java users can build Aurora and call a blocking service interface path
...
Do not promise generated `*Blocking` methods unless Aurora adopts an explicit generation mechanism.
