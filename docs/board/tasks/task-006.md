...
M3 is where Tramai becomes usable beyond stubs. The project needs one local-first and one cloud provider, plus deterministic registry-based routing between them.
...
Implementation exceeded the original minimal milestone by also adding OpenAI and OpenAI-compatible provider support.
