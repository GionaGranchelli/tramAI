...
/**
 * Assertion entry point for Tramai integration-style tests.
 */
object TramaiAssertions {
    /**
    ...
    ): TramaiAssertion = TramaiAssertion(provider, observer)
}

/**
 * Fluent assertion scope for one provider and observer pair.
 */
class TramaiAssertion internal constructor(
