...
class TramaiAutoConfigurationConditionsTest {
    ...
    fun `no providers and no default-provider -- context loads but invoking an AiService fails because no provider is registered for the model`() {
        val contextRunner = ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(OpenAiProviderAutoConfiguration::class.java, OllamaProviderAutoConfiguration::class.java, FileSecretValueResolverAutoConfiguration::class.java, TramaiSecretResolutionAutoConfiguration::class.java, TramaiAutoConfiguration::class.java))
