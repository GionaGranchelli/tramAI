...
class TramaiAutoConfigurationTest {
    ...
    fun `spring context destruction closes the runtime`() {
        ...
        ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(OpenAiProviderAutoConfiguration::class.java, FileSecretValueResolverAutoConfiguration::class.java, TramaiSecretResolutionAutoConfiguration::class.java, TramaiAutoConfiguration::class.java))
    ...
    fun `registers ai service beans and injects a custom provider bean`() {
        val contextRunner = ApplicationContextRunner()
            .withConfiguration(
                AutoConfigurations.of(OpenAiProviderAutoConfiguration::class.java, FileSecretValueResolverAutoConfiguration::class.java, TramaiSecretResolutionAutoConfiguration::class.java, TramaiAutoConfiguration::class.java),
            )
            .withUserConfiguration(TestApplication::class.java, ProviderConfiguration::class.java)
            .withPropertyValues(
