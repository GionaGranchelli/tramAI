...
> **TramAI is under active development.** Core library version 0.3.1 is released; several governance and sovereign-runtime capabilities on `master` remain unreleased and evolving. See [Project Status](docs/STATUS.md). The canonical [Product Positioning](docs/product/positioning.md) defines audiences, pillars, boundaries, and messaging.
