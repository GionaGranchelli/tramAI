...
/**
 * Applies the normalized Aurora timeout, when present, to a provider HTTP request.
 */
fun HttpRequest.Builder.applyAuroraTimeout(request: ModelRequest): HttpRequest.Builder = apply {
