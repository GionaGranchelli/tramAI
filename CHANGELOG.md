...
- Repeat denial evidence test (PR #180 follow-up). Added `repeat deny returns AlreadyDenied without creating duplicate evidence` to complete the duplicate-decision proof for the deny path, matching the existing repeat-approve coverage.
